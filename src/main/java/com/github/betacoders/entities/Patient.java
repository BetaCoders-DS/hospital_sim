...
public class Patient
{
  ...
  public void vitals(Vitals vitals) {
    if (vitals == null) {
      throw new IllegalArgumentException("Vital signs cannot be null.");
    }
    this.vitals = vitals;
  ...
  public void spawnTime(double spawnTime) {
    this.spawnTime = spawnTime;
  }

  public void waitStart(double waitStart) {
    this.waitStart = waitStart;
  }

  public double waitStart() {
    return waitStart;
  }

  public double waitAccum() {
    return waitAccum;
  }

  public void waitAccum(double waitAccum) {
    this.waitAccum = waitAccum;
  }
